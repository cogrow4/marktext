...
NovelCraft key bindings for Windows. Please see [general key bindings](KEYBINDINGS.md) for information how to use custom key bindings.
...
| `file.quit`         | <kbd>Ctrl</kbd>+<kbd>Q</kbd>                  | Quit NovelCraft                         |
