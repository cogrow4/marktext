...
1. Go to `novelcraft` folder
2. Install dependencies: `yarn install` or `yarn install --frozen-lockfile`
3. Build NovelCraft binaries and packages: `yarn run build`
4. NovelCraft binary is located under `build` folder
...
| Script          | Description                                      |
| --------------- | ------------------------------------------------ |
| `build`         | Build NovelCraft binaries and packages for your OS |
| `build:bin`     | Build NovelCraft binary for your OS                |
| `dev`           | Build and run NovelCraft in developer mode         |
