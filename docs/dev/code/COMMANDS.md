...
You can use either a class or object at runtime to register a command via the bus event `CMD::register-command`. A simple class example can be found below or a more complex [here](https://github.com/novelcraft/novelcraft/blob/develop/src/renderer/commands/quickOpen.js).
