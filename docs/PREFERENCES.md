...
| startUpAction          | String  | lastState     | The action after NovelCraft startup, open the last edited content, open the specified folder or blank page, optional value: `lastState`, `folder`, `blank` |
| defaultDirectoryToOpen | String  | `""`          | The path that should be opened if `startUpAction=folder`.                                                                                                  |
| language               | String  | en            | The language NovelCraft use.                                                                                                                                |
...
| imageDropAction                    | String  | folder             | The default behavior after paste or drag the image to NovelCraft, upload it to the image cloud (if configured), move to the specified folder, insert the path          |
...
| preferHeadingStyle  | String  | `atx`   | The preferred heading style in NovelCraft, optional value `atx` `setext`, [more info](https://spec.commonmark.org/0.29/#atx-headings) |
