...
NovelCraft can automatically copy your images into a specified directory or handle images from clipboard.
...
Note: The assets directory name must be a valid path name and NovelCraft need write access to the directory.
...
NovelCraft only saves images from clipboard into the specified local directory.
