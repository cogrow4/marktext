...
- [Open Collective에서 후원하기](https://opencollective.com/novelcraft)
...
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [![최신 버전](https://img.shields.io/github/downloads/novelcraft/novelcraft/latest/novelcraft-x64.dmg.svg)](https://github.com/novelcraft/novelcraft/releases/download/v0.17.1/novelcraft-x64.dmg) | [![최신 버전](https://img.shields.io/github/downloads/novelcraft/novelcraft/latest/novelcraft-setup.exe.svg)](https://github.com/novelcraft/novelcraft/releases/download/v0.17.1/novelcraft-setup.exe) | [![최신 버전](https://img.shields.io/github/downloads/novelcraft/novelcraft/latest/novelcraft-x86_64.AppImage.svg)](https://github.com/novelcraft/novelcraft/releases/download/v0.17.1/novelcraft-x86_64.AppImage) |

최신 버전의 새로운 기능을 보고 싶나요? [변경사항](.github/CHANGELOG.md)을 참조하세요.

#### 맥OS

최신 `novelcraft-%version%.dmg`를 [릴리즈 페이지](https://github.com/novelcraft/novelcraft/releases/latest)에서 다운로드하거나 [**homebrew cask**](https://github.com/caskroom/homebrew-cask)를 이용하여 설치할 수 있습니다. Homebrew-Cask를 이용하려면 [Homebrew](https://brew.sh/)가 설치되어 있어야 합니다.
...
마크 텍스트를 다운로드하여 설치 마법사(`novelcraft-setup-%version%.exe`)를 통해 설치하고 사용자별로 설치할 것인지 공용으로 설치할 것인지 선택하십시오.
...
모든 리눅스, 맥OS 그리고 윈도우 용 파일은 [릴리즈 페이지](https://github.com/novelcraft/novelcraft/releases/latest)에서 다운로드할 수 있습니다. 시스템에서 버전을 이용할 수 없을 시, [이슈](https://github.com/novelcraft/novelcraft/issues)를 열어주세요.
...
마크 텍스트에 새로운 기능을 추가하고 싶은가요? [로드맵](https://github.com/novelcraft/novelcraft/projects)을 참조하시어 이슈를 열어주세요.

## 기여자

마크 텍스트에 기여해주신 모든 분들께 감사합니다. [[기여자](https://github.com/novelcraft/novelcraft/graphs/contributors)]
