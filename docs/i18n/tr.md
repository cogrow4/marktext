...
<div align="center">
  <a href="https://twitter.com/intent/tweet?via=novelcraftme&url=https://github.com/novelcraft/novelcraft/&text=Uygulama%20için%20ne%20demek%20istersiniz?&hashtags=happyNovelCraft">
...
<h2 align="center">NovelCraft'e yardımda bulunma</h2>

NovelCraft, MIT lisanslı  ve açık kaynaklı bir projedir, ve en yeni versiyonu her zaman ücretsiz olarak GitHub'dan indirilebilir. NovelCraft hâlâ geliştirme aşamasında, ve bu geliştirme sponsorları sayesinde mümkün oluyor. Sponsor olmak isterseniz:

- [Become a backer or sponsor on Patreon](https://www.patreon.com/ranluo) or [One time donation](https://github.com/Jocs/sponsor.me)
- [Become a backer or sponsor on Open Collective](https://opencollective.com/novelcraft)

##### Open Collective ve Patreon arasında ne fark var?

Patreon: Tüm yardım direkt olarak NovelCraft'i yapan ve sürdüren Luo Ran (@jocs)'a, gider.
Open Collective: Bu platformda tüm masraf ve harcamalarımız şeffaftır. Para, NovelCraft'in geliştirilmesi ve sürdürülmesi, çevrimiçi ve çevrimdışı aktiviteleri, ve gerekli kaynaklara erişimi için kullanılacaktır.
Tüm sponsorlarımızın (hem Patreon hem Open Collective) isimleri ve logoları NovelCraft'in resmi web sitesinde ve README.md dosyasında yer alır.
...
1. Yazmayı sevdiğimiz için. Birçok markdown editörü kullandık, ve hala benim gereksinimlerimi tam anlamı ile karşılayanı bir editör yok. Yazarken dayanılmaz bir bug ile uğraşmaktan hoşlanmıyorum. **NovelCraft** sayfayı çizmek için virtual DOM kullanır, bu da hızlı ve açık kaynaklı olması gibi avantajlar sağlıyor. Bu yolla yazmayı ve markdown'u seven bütün herkes NovelCraft kullanabilir.
2. Yukarıda bahsettiğim gibi **NovelCraft** daima açık kaynak olacak. Tüm markdown sevenlerin koda katkıda bulunmasını ve **NovelCraft**'in daha popüler bir markdown editör olmasını ümit ediyorum.
3. Birçok markdown editörü var, ve her biri kendi avantajlarına sahip. Tüm markdown kullanıcılarını tatmin etmek zor, ama biz **NovelCraft** 'in markdown kullanıcılarının gereksinimlerini mümkün oldukça tatmin edebileceğini umuyoruz. **NovelCraft** hala mükemmel değil, ancak biz elimizden geldiğince iyileştirmeye çalışıyoruz.
...
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [![son sürüm](https://img.shields.io/github/downloads/novelcraft/novelcraft/latest/novelcraft-x64.dmg.svg)](https://github.com/novelcraft/novelcraft/releases/download/v0.17.1/novelcraft-x64.dmg) | [![son sürüm](https://img.shields.io/github/downloads/novelcraft/novelcraft/latest/novelcraft-setup.exe.svg)](https://github.com/novelcraft/novelcraft/releases/download/v0.17.1/novelcraft-setup.exe) | [![son sürüm](https://img.shields.io/github/downloads/novelcraft/novelcraft/latest/novelcraft-x86_64.AppImage.svg)](https://github.com/novelcraft/novelcraft/releases/download/v0.17.1/novelcraft-x86_64.AppImage) |

Son sürümde gelen değişiklikler için [CHANGELOG](.github/CHANGELOG.md)'a bakınız.

#### macOS

NovelCraft'i [indirmeler](https://github.com/novelcraft/novelcraft/releases/latest)'den`novelcraft-%sürüm%.dmg` olarak  indirebilir, ya da [**homebrew cask**](https://github.com/caskroom/homebrew-cask) yoluyla kurabilirsiniz. Homebrew-Cask kullanabilmek için [Homebrew](https://brew.sh/)'ün kurulu olması gerekir.
...
(`novelcraft-setup-%version%.exe`) yükleyiciyi indirip çalıştırın.

Veya, NovelCraft'i [Chocolatey](https://chocolatey.org/) yoluyla kurun. Chocolatey kullanabilmek için [Chocolatey](https://chocolatey.org/install)'in kurulu olması gerekir.
...
Tüm Linux, macOS ve Windows sürümleri [indirmeler](https://github.com/novelcraft/novelcraft/releases/latest)'de bulunur. Kendi platformunuz için bir sürüm bulamıyorsanuz, [issue](https://github.com/novelcraft/novelcraft/issues) açınız.

## Geliştirme

Eğer **NovelCraft** kendiniz derlemek isterseniz, lütfen [geliştirici dökümantasyonuna](../../CONTRIBUTING.md#build-instructions) bakın.

- [Kullanıcı dokümantasyonu](../README.md)
- [Geliştirici dokümantasyonu](../dev/README.md)

**NovelCraft** hakkında sorularınız için issue açabilirsiniz. Lütfen standart formatı kullanın. Direkt olarak PR açmak tabiki hoş karşılanır.

## Entegrasyonlar

- [Alfred Workflow](http://www.packal.org/workflow/mark-text): macOS Alfred uygulaması için bir iş akışı: NovelCraft ile dosya/klasör açmak için "mt" kullanılır.

## Katkıda Bulunmak

NovelCraft geliştirme aşamasındadır. Lütfen pull request açmadan önce [Katkıda bulunma Rehberine](../../CONTRIBUTING.md) bakınız. NovelCraft'e katkıda bulunmak için [roadmap](https://github.com/novelcraft/novelcraft/projects)'e bakınız.

## Destekçiler

Tüm destekçilerimize teşekkürler! [[destekçiler](https://github.com/novelcraft/novelcraft/graphs/contributors)]

NovelCraft logosunu tasarlayan @[Yasujizr](https://github.com/Yasujizr)'a özel teşekkürler.
