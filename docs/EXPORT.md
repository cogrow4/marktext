...
NovelCraft allows you to export a markdown document as PDF and HTML file or to print the document.
...
NovelCraft allows you to select a page theme before exporting. You can learn more about page themes [here](EXPORT_THEMES.md).
...
![](assets/novelcraft-export-header.png)

![](assets/novelcraft-export-pdf.png)
