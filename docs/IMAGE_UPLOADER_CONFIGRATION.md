...
3. Config in NovelCraft Preferences window. click `CmdOrCtrl + ,` to open NovelCraft Preferences window.
...
5. Paste an image into NovelCraft and open you created repo to see the uploaded image.
