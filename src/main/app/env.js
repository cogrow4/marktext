...
const setupEnvironment = args => {
  ...
  const debug = args['--debug'] || !!process.env.NOVELCRAFT_DEBUG || process.env.NODE_ENV !== 'production'
  ...
  global.NOVELCRAFT_DEBUG = debug
  global.NOVELCRAFT_DEBUG_VERBOSE = verbose
  global.NOVELCRAFT_SAFE_MODE = safeMode
